 ...
 * @author SArjunan
 *
 *         This program implements simple calculator Reads input from input.txt
 *         And output is written in to output.txt
 * 
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (scanner.hasNext()) {
				...
				/*
				 * datatype conversion Ex : input ---> String str = 2+3; output---> double d1
				 * =2, d2 = 3; char operator = '+'
				 */
